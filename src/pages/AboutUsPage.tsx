    ...
    <section>
      ...
      <div className="person-cards">
        <article className="card Personen">
          <img className="person-image" src="public/team-pictures/kami.png" alt="Kami" />
          <h3>Kami</h3>
          <p>“I’m Kami from Cologne, and I enjoy creating innovative apps and websites. Have fun using the Pokémon app!”
          </p>
          <h4>Contact:</h4>
        ...
        <article className="card Personen">
          <img className="person-image" src="public/team-pictures/anne.png" alt="Anne" />
          <h3>Anne</h3>
          <p>
          “Hi, I’m Anne, I’m from Kiel and I’m a true Northern light. With creative background knowledge from my past as a media designer, I love giving websites the final touch.”
          </p>
          <h4>Contact:</h4>
          <a href="https://github.com/Anne-SophieNehls">Github</a>
          <a href="https://www.linkedin.com/in/anne-sophie-nehls-89ba671b7/">LinkedIn</a>
        </article>
      </div>
    </section>
  );
